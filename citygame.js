...
function init() {
    ...
    const onKeyDown = function (event) {
        switch (event.code) {
            ...
            case 'Space':
                ...
                break;
                case 'KeyC' :
                    if(isCrouching != true) camera.positiony.y -=0.4;
                isSprinting = true;
                break;
    ...
    loader.load('./Jacksonscity.glb', function(gltf){
        let city = gltf.scene; //loadcity
        scene.add(city);//ladcitytoseen
        city.traverse(function(glb){
            objects.push(glb); //addcityobjects to collison list
        });
